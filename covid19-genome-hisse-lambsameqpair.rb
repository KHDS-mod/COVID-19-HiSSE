...
monitors.append( mnModel(filename="RES_HISSE_ST6NOULTRA_LAMBSAMEQPAIR_1/model.log", printgen=1) )
...
monitors.append( mnStochasticCharacterMap(cdbdp=timetree,
					  printgen=1,
					  filename="RES_HISSE_ST6NOULTRA_LAMBSAMEQPAIR_1/stoch_char_map.log",
					  include_simmap=true) )
monitors.append( mnScreen(printgen=1, lambda_obscomm, lambda_hid, q_obs, q_hid) )
